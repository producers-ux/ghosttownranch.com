    ...
    <div class="pdp-scroll">
      ...
      <div class="pdp-content">
        ...
        <div class="pdp-badges">
          ...
          <span class="pdp-badge">Cruelty-Free</span>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hash && ['brand','catalog','wholesale','quiz'].indexOf(hash) !== -1) {
      ...
      if (filterParam && hash === 'catalog') {
        ...
        var fIdx = filterMap[filterParam];
        if (filterBtns && typeof fIdx === 'number' && filterBtns[fIdx]) filterBtns[fIdx].click();
      }
    }
  });
...
window.openPDP = function(trigger) {
  ...
  if (badgesEl) {
    ...
    badgesEl.innerHTML = isMerch
      ...
      : '<span class="pdp-badge">COSMOS Certified</span><span class="pdp-badge">Cruelty-Free</span><span class="pdp-badge">Vegan</span>';
  }
